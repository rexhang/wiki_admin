  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><?php echo $title; ?></strong> / <small>Title</small></div>
      </div>
      <hr/>
...
<script type="text/javascript">
  ...
  clipboard.on('success', function(e) {
    var links = $('#copyDom').val();
    alert('复制成功!!!链接是：'+links+'赶紧分享给别人吧！');
    e.clearSelection();
});
</script>
<script type="text/javascript">
