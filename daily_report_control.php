...
<?php $Department = @$_GET['id'] ?>

  <!-- content start -->
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><span><?php echo $Department; ?></span> - 管理日报权限</strong> / <small style="white-space: nowrap;">Dailyreport control</small></div>
      </div>
      <hr/>
        ...
        <form class="am-form-inline am-padding" role="form">
          ...
          <table class="am-table am-table-bordered am-table-striped am-table-compact am-text-center rex-margin-top-15">
            ...
            <tr>
              ...
              <th class="am-text-center rex-width-50percent">部门</th>
            </tr>
            </thead>
            <tbody id="selcheck">
            <tr>
